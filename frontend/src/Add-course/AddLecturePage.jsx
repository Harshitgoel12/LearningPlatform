...
const AddLecturePage = ({sectionId,setAddLecture}) => {
  ...
  return (
    <div className='absolute w-1/2  z-20 bg-[#161D29] top-10 right-92 shadow-2xl rounded-lg '>
    <form className=''>
    ...
    <input type="text" name='Title' onChange={handleChange} className='bg-[#2C333F] ms-8 w-11/12 px-2 py-3 rounded-lg  text-gray-400  outline-none focus:border-yellow-200 focus:border-1 shadow-2xl' placeholder='Enter Lecture Title' />
    </div>
    <div className='flex flex-col '>
        <label htmlFor="" className='text-white text-md ms-8 mt-2 mb-2'>Lecture Description</label>
    <textarea rows={6} name='Description' onChange={handleChange} type="text" className='bg-[#2C333F] ms-8 w-11/12 px-2 py-3 rounded-lg  text-gray-400  outline-none focus:border-yellow-200 focus:border-1 shadow-2xl' placeholder='Enter Lecture Title' />
    </div>
