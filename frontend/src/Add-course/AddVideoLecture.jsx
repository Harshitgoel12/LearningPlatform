...
const AddVideoLecture = () => {
  ...
  return (
    <div className='w-11/12'>
      <form onSubmit={handleSubmit} className='w-full bg-gray-800 rounded-lg'>
        ...
        <div>
            <button className='text-yellow-300 border-2 rounded-lg mt-5 ms-5 outline-none border-yellow-400 bg-gray-800 px-3 py-2'>Create Section</button>
        </div>
        ...
        <div className='flex flex-row justify-end gap-3 me-5 mb-8'>
